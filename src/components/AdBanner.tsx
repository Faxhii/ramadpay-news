    ...
    <div style={{
      ...
      >
        <div style={{
          ...
          <span style={{ color: currentApp.badgeColor }}>●</span> {currentApp.badge}
        </div>
        ...
        <div style={{
          ...
          {currentApp.links.android && (
            <a
              href={currentApp.links.android}
              target="_blank"
          ...
          {currentApp.links.ios && (
            <a
              href={currentApp.links.ios}
              target="_blank"
              rel="noopener noreferrer"
              className="app-store-btn"
              style={{
          ...
          {currentApp.links.web && (
            <a
              href={currentApp.links.web}
              target="_blank"
              rel="noopener noreferrer"
              className="app-store-btn"
              style={{
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                <span style={{ fontSize: '0.65rem', lineHeight: 1, color: 'rgba(255,255,255,0.7)' }}>Visit Website</span>
                <span style={{ fontSize: '1rem', fontWeight: 600, lineHeight: 1.1 }}>Learn More</span>
              </div>
            </a>
          )}
        </div>
      ...
      {/* Pagination dots to show rotation status */}
      <div style={{ display: 'flex', gap: '6px', position: 'absolute', bottom: '20px' }}>
        {apps.map((_, idx) => (
          <div 
            key={idx}
            style={{ 
              ...
              height: '8px', 
              borderRadius: '50%', 
              backgroundColor: currentIndex === idx ? '#FFFFFF' : 'rgba(255,255,255,0.3)',
